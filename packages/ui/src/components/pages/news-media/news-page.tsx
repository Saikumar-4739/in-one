  ...
  const fetchNews = async () => {
    try {
      ...
      if (response.status === true) {
        setNews(response.data.news || response.data); // Adjust based on API response structure
        setTotal(response.data.total || response.data.length); // Adjust based on API response
      } else {
